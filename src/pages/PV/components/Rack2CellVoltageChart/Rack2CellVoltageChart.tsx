...
const RACK_2_PREFIX = ".01_BESS_1.BMS.RACK2.";
const LABELS_PREFIX = "RACK 2";
...
export const Rack2CellVoltageChart = () => {
  const { prefix: clientPrefix } = useClientContext();
  const metrics = createPaths(clientPrefix!, RACK_2_PREFIX);
  ...
  return (
    ...
    >
      <Typography variant={"h6"}>RACK 2 CELL VOLTAGE</Typography>
      <BarChart
        options={options}
        series={chartSeries}
        labels={chartLabels}
